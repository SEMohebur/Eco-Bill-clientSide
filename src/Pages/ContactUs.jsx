...
const ContactUs = () => {
  ...
  return (
    <div className=" bg-base-200 flex flex-col text-center p-10">
      {/* contact us  */}
      <div className=" py-5">
        <motion.h2
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8  mx-auto text-gray-600">
          <div className=" p-6 rounded-2xl shadow-lg flex flex-col items-center text-center bg-base-200 cursor-pointer hover:bg-base-300 duration-300">
      ...
      <div className=" bg-base-300 p-10 rounded-2xl">
